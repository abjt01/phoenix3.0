...
/**
 * Returns the total number of participants (data rows) for a given spreadsheet.
 * 
 * @param {string} spreadsheetId 
 * @returns {number}
 */
export async function getParticipantCount(spreadsheetId) {
    ...
    try {
        ...
        console.error("Error fetching participant count for", spreadsheetId, error.message);
        return 0; // Return 0 if the tab doesn't exist or other errors happen
    }
}
